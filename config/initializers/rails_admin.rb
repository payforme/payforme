# RailsAdmin config file. Generated on April 24, 2013 02:44
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Payforme', 'Admin']
  ...
  # config.excluded_models = ['Payment', 'Shop']

  # Include specific models (exclude the others):
  # config.included_models = ['Payment', 'Shop']
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your shop.rb model definition
